...
// Mouse
#define ENGINE_MOUSE_BUTTON_LEFT    :Enginel::Button::Left
#define ENGINE_MOUSE_BUTTON_RIGHT   :Enginel::Button::Right
#define ENGINE_MOUSE_BUTTON_MIDDLE  :Enginel::Button::Middle
