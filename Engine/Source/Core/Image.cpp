...
//         imgui_impl_vulkan.cpp static uint32_t GetVulkanMemoryType(VkMemoryPropertyFlags properties, uint32_t
//         type_bits)
//         {
...
//             sampler_info.addressModeU  = VK_SAMPLER_ADDRESS_MODE_REPEAT; // outside image bounds just use border
//             color sampler_info.addressModeV  = VK_SAMPLER_ADDRESS_MODE_REPEAT; sampler_info.addressModeW  =
//             VK_SAMPLER_ADDRESS_MODE_REPEAT; sampler_info.minLod        = -1000; sampler_info.maxLod        = 1000;
