...
namespace Engine
{
    ...
    public:
        ...
        static Ref<Shader>
        Create(const std::string& filepath, bool forceCompile = false, bool disableOptimization = false);
        static Ref<Shader>
        LoadFromShaderPack(const std::string& filepath, bool forceCompile = false, bool disableOptimization = false);
        ...
        static constexpr const char* GetShaderDirectoryPath() { return "Resources/Shaders/"; }
    };
