...
namespace Engine
{
    ...
    bool Input::IsKeyDown(KeyCode keycode)
    {
        ...
        //            auto  state = glfwGetKey(static_cast<GLFWwindow*>(window.GetNativeWindow()),
        //            static_cast<int32_t>(keycode)); return state == GLFW_PRESS || state == GLFW_REPEAT;
        //        }
        //
        //        auto&         window  = static_cast<WindowsWindow&>(Application::Get().GetWindow());
        ...
        //                continue;
        //
        //            GLFWwindow* windowHandle = *(GLFWwindow**)viewport->PlatformUserData; // First member is
        //            GLFWwindow if (!windowHandle)
        //                continue;
    ...
    bool Input::IsMouseButtonDown(MouseButton button)
    {
        ...
        //            auto& window = static_cast<WindowsWindow&>(Application::Get().GetWindow());
        //            auto  state =
        //                glfwGetMouseButton(static_cast<GLFWwindow*>(window.GetNativeWindow()),
        ...
        //                continue;
        //
        //            auto state = glfwGetMouseButton(static_cast<GLFWwindow*>(windowHandle),
        //            static_cast<int32_t>(button)); if (state == GLFW_PRESS || state == GLFW_REPEAT)
        //            {
        //                pressed = true;
        //                break;
        //            }
    ...
    void Input::SetCursorMode(CursorMode mode)
    {
        //        auto& window = static_cast<WindowsWindow&>(Application::Get().GetWindow());
        //        glfwSetInputMode(
        //            static_cast<GLFWwindow*>(window.GetNativeWindow()), GLFW_CURSOR, GLFW_CURSOR_NORMAL + (int)mode);
        //
    ...
    {
        //        auto& window = static_cast<WindowsWindow&>(Application::Get().GetWindow());
        return (CursorMode)(glfwGetInputMode(static_cast<GLFWwindow*>(Application::Get().GetWindow()), GLFW_CURSOR) -
                            GLFW_CURSOR_NORMAL);
    }

    bool Input::IsControllerPresent(int id) { return s_Controllers.find(id) != s_Controllers.end(); }
    ...
    bool Input::IsControllerButtonPressed(int controllerID, int button)
    {
        ...
        return contoller.ButtonStates.find(button) != contoller.ButtonStates.end() &&
               contoller.ButtonStates[button].State == KeyState::Pressed;
    }
    ...
    bool Input::IsControllerButtonHeld(int controllerID, int button)
    {
        ...
        auto& contoller = s_Controllers.at(controllerID);
        return contoller.ButtonStates.find(button) != contoller.ButtonStates.end() &&
               contoller.ButtonStates[button].State == KeyState::Held;
    }
    ...
    bool Input::IsControllerButtonReleased(int controllerID, int button)
    {
        ...
        auto& contoller = s_Controllers.at(controllerID);
        return contoller.ButtonStates.find(button) != contoller.ButtonStates.end() &&
               contoller.ButtonStates[button].State == KeyState::Released;
    }
