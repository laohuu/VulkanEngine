...
namespace Engine
{
    ...
    {
        //        ENGINE_CORE_ERROR_TAG("GLFW", "GLFW Error ({0}): {1}", error, description);
    }

    static bool s_GLFWInitialized = false;

    Window* Window::Create(const WindowSpecification& specification) { return new WindowsWindow(specification); }

    WindowsWindow::WindowsWindow(const WindowSpecification& props) : m_Specification(props) {}
    ...
    void WindowsWindow::Init()
    {
        ...
        else
        {
            m_Window = glfwCreateWindow(
                (int)m_Specification.Width, (int)m_Specification.Height, m_Data.Title.c_str(), nullptr, nullptr);
        }
        ...
        if (isRawMouseMotionSupported)
            ...
            //            ENGINE_CORE_WARN_TAG("Platform", "Raw mouse motion not supported.");
    ...
    bool WindowsWindow::IsVSync() const { return m_Specification.VSync; }
